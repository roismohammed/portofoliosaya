        ...
        return (
            <div id="portfolio" style={{ minHeight: '100vh',backgroundColor: 'rgb(50,55,68)' }} >
                <div className="container">
                    <div className="row portofolio text-white p-5 mt-5">
                        <h1 data-aos="fade-down"
                            data-aos-easing="linear"
                            data-aos-duration="1300" className="text-portofolio text-white  text-center">Latest <span style={{ color: '#02E7FD', fontWeight: 'bold' }} > Project</span></h1>
