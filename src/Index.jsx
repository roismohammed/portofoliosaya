        ...
        return (
            <Guest>
                <div style={{ minHeight: '100vh' }} className="container">
                    <div className="row">
                        <div className="col-md-7 p-5 mt-2">
                            <div className="box text-white">
                                ...
                                <p className="deskripsi  animate__animated animate__slideInDown ">""Saya seorang Software Engineer junior dari Indonesia yang menggunakan JavaScript dan Framework React.js" Saat ini, saya bekerja sebagai freelancer
                                  </p>
                        ...
                        <div className="col-md-5 custom-animation ">
                            <img
                                width={'680px'}
